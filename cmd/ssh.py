from lib763.cmd.cmd import cmd_operator

class ssh_operator:
    def __init__(self, user_name: str, host_name: str, key_path: str) -> None:
        """
        @param:
    ...
    def __init_ssh(self):
        ...
        SSH接続を初期化する
        """
        self.cmd.execute(f'ssh -i {self.__key_path} {self.__user}@{self.__host}')
        self.__state = True
